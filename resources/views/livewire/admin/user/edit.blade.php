        ...
        <div class="border-2 border-gray-600 rounded-xl shadow-xl p-4 sm:p-7 dark:bg-neutral-800">
            ...
            <form wire:submit.prevent="update">
                ...
                <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                    ...
                    <div class="sm:col-span-9">
                        <input type="text" wire:model="username" class="py-2 px-3 pe-11 block w-full border-2 border-black shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                        @error('username')
                        <span class="text-red-500 text-xs">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="mt-5 flex justify-end gap-x-2">
                    <a href="{{ route('user.index') }}" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-red-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
                        Back
                    </a>
