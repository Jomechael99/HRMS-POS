                        ...
                        <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-neutral-700">
                            ...
                            <div>
                                <div class="inline-flex gap-x-2">
                                    <a href="{{ route('user.create') }}" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-slide-down-animation-modal" data-hs-overlay="#hs-slide-down-animation-modal">
...
{{--                                    <th class="w-1/5 px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-800 dark:text-neutral-200 text-center">
                                ...
                                @foreach($users as $data)
                                    <tr>
                                        ...
                                        <td class="px-4 py-3 text-sm text-gray-800 dark:text-neutral-200">{{ $data->first_name }} {{ $data->last_name }}</td>
                                        ...
                                        <td class="px-4 py-3 text-sm text-gray-800 dark:text-neutral-200">{{ $data->email }}
                                        <td class="px-4 py-3 text-sm text-gray-800 dark:text-neutral-200">
                                        ...
                                        <td class="px-1 py-3 text-center ">
                                            <a type="button" href="{{ route('user.edit', $data->id) }}" class="py-2 px-3 gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
                                                Edit
                                            </a>
