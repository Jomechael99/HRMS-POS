        ...
        <div class="flex flex-col">
            <div class="-m-1.5 overflow-x-auto">
                <div class="p-1.5 min-w-full align-middle">
                    <div
                        class="bg-white border border-gray-400 rounded-xl shadow-sm overflow-hidden dark:bg-neutral-800 dark:border-neutral-700">
                        <!-- Header -->
                        <div
                        ...
                        <table class="w-full table-fixed border-collapse divide-y divide-gray-400 dark:divide-neutral-700 border border-gray-300 dark:border-neutral-600">
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-3 text-sm text-gray-800 dark:text-neutral-200 text-center">2025-02-24</td>
