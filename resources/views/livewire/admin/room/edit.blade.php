        ...
        <div class="border-2 border-gray-600 rounded-xl shadow-xl p-4 sm:p-7 dark:bg-neutral-800">
            ...
            <form wire:submit.prevent="update">
                ...
                <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                    ...
                    <div class="sm:col-span-9">
                        <input type="text" wire:model="price" class="py-2 px-3 pe-11 block w-full border-2 border-black shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                        @error('price')
                        <span class="text-red-500 text-xs">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="sm:col-span-9 flex items-center">
                        <input type="checkbox"
                               ...
                               class="py-2 px-3 pe-11 border-2 border-black shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                               {{ $is_featured ? 'checked' : '' }}
                        >
                        @error('is_featured')
                        <span class="text-red-500 text-xs">{{ $message }}</span>
